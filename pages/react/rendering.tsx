  ...
  return (
    <TopicPage heading='Rendering'>
      ...
      <LoggingSection
        showLog
        id='6'
        heading='Normal component re-renders when its parent component re-renders'
      />
      <Divider />
      <MemoizedLoggingSection
        showLog
        id='7'
        heading='React.memo component only re-renders when the props change while its parent component re-renders'
      />
    </TopicPage>
  );
};
